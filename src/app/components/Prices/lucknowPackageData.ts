...
const lucknowPrices: TierPriceMap = {
  'Super Saver': {
    'Quint': 69786 + 3000,
    'Quad': 70786 + 3000,
    'Triple': 72786 + 3000,
...
// This is the complete data object for the dedicated Lucknow page.
export const lucknowPackageData: PackageData = {
  name: "15 Days Regular Umrah from Lucknow",
  image: "/packages/umrah/umrah2.jpeg",
  reviews: 28,
  rating: 5,
  badges: [{ text: "Featured", color: "bg-blue-500" }],
  features: [ "Direct Flight from Lucknow", "Deluxe Hotels near Haram", "Special Guided Ziyarat" ],
  slug: "15-days-regular-umrah-from-lucknow",
  prices: lucknowPrices
};
