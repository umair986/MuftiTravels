      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-[#06131D] tracking-tight mb-4">
            Offers to Inspire Your{" "}
            <span className="gold-gradient-text italic">Blessed Journey</span>
          </h2>
          <p className="text-stone-600 font-body text-base sm:text-lg leading-relaxed">
            Take advantage of special group concessions, family booking rates,
            and seasonal packages designed with extraordinary value.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-[#F3E5AB] flex items-center gap-1">
                  <FiUsers className="w-3.5 h-3.5 text-[#D4AF37]" /> 8+
                  Passengers
                </span>
              </div>
              ...
              <p className="text-stone-300 font-body text-sm leading-relaxed mb-6">
                Traveling with extended family or community members? Enjoy
                dedicated private transport, interconnected hotel rooms, and
                exclusive discount per pilgrim.
              </p>

              {/* Perks List */}
              <div className="space-y-2 mb-6 text-xs text-stone-300">
                <p className="flex items-center gap-2">
                  <FiCheck className="text-emerald-400" /> Direct/Via Flights
                  from Mumbai & Delhi
                </p>
                <p className="flex items-center gap-2">
                  <FiCheck className="text-emerald-400" /> Private AC Coach for
                  Group Ziyarat
                </p>
                <p className="flex items-center gap-2">
                  <FiCheck className="text-emerald-400" /> Complimentary
                  Dedicated Group Khadim
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-baseline gap-1">
                  <span className="font-display text-2xl sm:text-3xl font-bold text-[#F3E5AB]">
                    ₹71,786
                  </span>
          ...
          {/* Offer Card 2: Ramadan Early Bird */}
          <div className="bg-gradient-to-br from-[#0D2A3A] to-[#0B1E28] text-white rounded-3xl p-6 sm:p-8 border border-[#D4AF37]/30 shadow-2xl flex flex-col justify-between relative overflow-hidden group">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-[#F3E5AB] flex items-center gap-1">
                  <FiCalendar className="w-3.5 h-3.5 text-[#D4AF37]" /> Ramadan
                  Special
                </span>
              </div>

              <h3 className="font-display text-2xl sm:text-3xl font-bold text-white mb-2">
                Ramadan Mubarak Advance Registration
              </h3>
              <p className="text-stone-300 font-body text-sm leading-relaxed mb-6">
                Experience the spiritual zenith of Laylatul Qadr and Taraweeh
                prayers in the Two Holy Mosques. Secure guaranteed Clock Tower
                accommodations before peak price surges.
              </p>

              {/* Perks List */}
              <div className="space-y-2 mb-6 text-xs text-stone-300">
                <p className="flex items-center gap-2">
                  <FiCheck className="text-emerald-400" /> First 15 Days & Last
                  15 Days Options
                </p>
                <p className="flex items-center gap-2">
                  <FiCheck className="text-emerald-400" /> Daily Sahoor & Iftar
                  Buffet Inclusions
                </p>
                <p className="flex items-center gap-2">
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <a
                href="https://wa.me/919323063712?text=As-salamu%20alaykum,%20I%20would%20like%20to%20register%20early%20for%20a%20Ramadan%20Umrah%20package."
                target="_blank"
