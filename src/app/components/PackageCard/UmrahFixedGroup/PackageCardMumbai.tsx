    ...
    >
      ...
      <div className="relative h-60 w-full overflow-hidden bg-stone-900">
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-center">
          <span className="px-3 py-1 rounded-full text-xs font-bold text-white bg-emerald-700/90 backdrop-blur-md shadow-sm border border-emerald-500/30 flex items-center gap-1">
            <FaPlane className="w-3 h-3" /> Direct Mumbai Flight
          </span>
        ...
        <div className="absolute bottom-3 left-3 flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#06131D]/85 backdrop-blur-md text-[#F3E5AB] text-xs font-medium border border-[#D4AF37]/30">
          ...
          <span>50m - 150m to Haramain</span>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 py-3 border-y border-stone-100 text-xs text-stone-600 mb-4">
            <span className="flex items-center gap-1.5 font-medium">
              <FaPlane className="text-[#D4AF37] w-3 h-3" /> Direct Flight (BOM)
            </span>
            <span className="flex items-center gap-1.5 font-medium">
            ...
            <span className="flex items-center gap-1.5 font-medium">
              <FaShieldAlt className="text-[#D4AF37] w-3 h-3" /> Visa + Insurance
            </span>
          </div>
        </div>
        ...
        <div className="pt-2 flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline gap-1">
              <span className="font-display text-2xl font-bold text-[#06131D]">₹69,786</span>
