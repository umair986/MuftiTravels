...
export default function PackageCard25Days({
  handleBookNow,
}: {
  handleBookNow: () => void;
}) {
  return (
    ...
    >
      <div className="relative h-60 w-full overflow-hidden bg-stone-900">
        <Image
          src="/packages/package3.webp"
          alt="25 Days Super Saver Land Package"
          fill
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-center">
          <span className="px-3 py-1 rounded-full text-xs font-bold text-white bg-emerald-700/90 backdrop-blur-md shadow-sm border border-emerald-500/30">
            Economy Special
          </span>
        ...
        <div>
          <div className="flex items-center justify-between mb-2.5">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-stone-500">(25 reviews)</span>
            </div>
          ...
          <h3 className="font-serif text-xl font-bold text-[#06131D] group-hover:text-[#946E19] transition-colors line-clamp-1 mb-3">
            25 Days Super Saver Land Package
          </h3>

          <div className="grid grid-cols-2 gap-2 py-3 border-y border-stone-100 text-xs text-stone-600 mb-4">
            <span className="flex items-center gap-1.5 font-medium">
              <FaHotel className="text-[#D4AF37] w-3 h-3" /> Budget Accommodation
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FaBus className="text-[#D4AF37] w-3 h-3" /> Shuttle & Transport
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FaShieldAlt className="text-[#D4AF37] w-3 h-3" /> Visa Included
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FiClock className="text-[#D4AF37] w-3 h-3" /> 24/7 Helpline
            </span>
          </div>
        </div>
        ...
        <div className="pt-2 flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline gap-1">
              <span className="font-display text-2xl font-bold text-[#06131D]">₹51,786</span>
