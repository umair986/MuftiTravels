...
export default function PackageCard30Days({
  handleBookNow,
}: {
  handleBookNow: () => void;
}) {
  return (
    ...
    >
      <div className="relative h-60 w-full overflow-hidden bg-stone-900">
        <Image
          src="/packages/package2.webp"
          alt="30 Days Super Saver Land Package"
          fill
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-center">
          <span className="px-3 py-1 rounded-full text-xs font-bold text-white bg-blue-700/90 backdrop-blur-md shadow-sm border border-blue-500/30">
            Extended Stay
          </span>
        ...
        <div className="absolute bottom-3 left-3 flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#06131D]/85 backdrop-blur-md text-[#F3E5AB] text-xs font-medium border border-[#D4AF37]/30">
          ...
          <span>Long Term Pilgrimage</span>
        </div>
      ...
      <div className="p-6 flex flex-col flex-1 justify-between">
        <div>
          ...
          <h3 className="font-serif text-xl font-bold text-[#06131D] group-hover:text-[#946E19] transition-colors line-clamp-1 mb-3">
            30 Days Super Saver Land Package
          </h3>

          <div className="grid grid-cols-2 gap-2 py-3 border-y border-stone-100 text-xs text-stone-600 mb-4">
            <span className="flex items-center gap-1.5 font-medium">
              <FaHotel className="text-[#D4AF37] w-3 h-3" /> Long Stay Hotels
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FaBus className="text-[#D4AF37] w-3 h-3" /> Group Ziyarat
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FaShieldAlt className="text-[#D4AF37] w-3 h-3" /> 1-Month Visa
            </span>
            <span className="flex items-center gap-1.5 font-medium">
              <FiClock className="text-[#D4AF37] w-3 h-3" /> Ground Support
            </span>
          </div>
        </div>
        ...
        <div className="pt-2 flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline gap-1">
              <span className="font-display text-2xl font-bold text-[#06131D]">₹58,786</span>
